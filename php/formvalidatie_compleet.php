...
<body>
    ...
    <form method="POST">
        <fieldset>
            ...
            Website: <input type="text" name="txtWebsite"><?php echo "<span class=\"red\">$websiteE</span>"; ?><br>
            ...
            <input type="radio" name="geslacht" value="man" id="radioM"><label for="radioM">Man</label><span class="red">*</span><?php echo "<span class=\"red\">$geslachtE</span>"; ?><br>
